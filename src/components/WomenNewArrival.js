...
const WomenNewArrival = ({getCatalog}) => {

    const url = getProducts("branded-shop-new-arrivals-women")+"pagesize=10";
    ...
    return (
        <div className="WomenNewArrival centerDiv"> 
        {
        ...
        <div className="hp-mod-card card-categories J_Categories J_NavChangeHook">
                    <div className="hp-mod-card-header d-flex justify-content-between">
                        ...
                        <a className="button" onClick={()=>getCatalog("branded-shop-new-arrivals-women")}>See More &#187; </a>
                    </div>
