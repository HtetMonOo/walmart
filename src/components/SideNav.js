...
const SideNav = ({ showSearch, search, showCatalog, cat_name, categories, getCatalog, classPart, filter, filterValue, newArrival, instock, bestSeller, promo }) => {
    return (
        <div className="SideNav wrapper">
            <nav id="sidebar" className={classPart}>
                ...
                <ul className="list-unstyled components">
                    ...
                    <li>
                        <a href="#pageSubmenu" data-toggle="collapse" aria-expanded="false" className="dropdown-toggle small">Size</a>
